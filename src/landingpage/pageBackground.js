...
const PageBackground = () =>{
    ...
    return(
        <Box>
            <Box component="img" src="/static/img/blob_back.png" sx={{width:"100%", position:'fixed', zIndex:-1, marginTop:-45}}></Box>
            <Container maxWidth="sm" sx={{paddingTop:"300px",opacity:"90%", textAlign:'-webkit-center'}}>
